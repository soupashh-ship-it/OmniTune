...
- `0.8.1–0.8.5`: Quick Picks personalization, pagination, UI refinement.
- `0.9.0`: OmniGlass UI overhaul, lyrics bottom sheet, settings sub-navigation.
- `0.9.1`: Discord Rich Presence integration, javax.inject/Hilt fixes.
...
4. Verify or downgrade Library, widget, accessibility, tempo/pitch, equalizer, Last.fm, Firebase, and migration claims. (Discord RPC verified in v0.9.1.)
