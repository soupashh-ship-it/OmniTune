...
import com.omnitune.app.ui.theme.NewReleaseCardShape
                    ...
                    when (item) {
                        ...
                        is HomeItem.PlaylistItem -> {
                             ...
                             val tempSong = remember(item.playlist) {
                                 Song(item.playlist.id, item.playlist.name, item.playlist.uploaderName, "Playlist", 0L, item.playlist.thumbnailUrl, com.omnitune.app.models.SongSource.YOUTUBE)
                             }
...
fun GridSection(
    ...
    val isLandscape = com.omnitune.app.ui.utils.isLandscape()
