...
import com.omnitune.app.ui.component.primitives.AnimatedPlayerButton
...
fun PlaybackControls(
    ...
    val haptics = com.omnitune.app.ui.utils.rememberHaptics()
        ...
        Box(
            ...
            AnimatedContent(
                ...
                Icon(
                    ...
                    tint = if (mode != Player.REPEAT_MODE_OFF) dominantColors.accent else dominantColors.onBackground.copy(alpha = 0.6f)
                )
            }
        }
    }
