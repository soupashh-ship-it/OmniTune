...
fun ArtistMenu(
    ...
    LazyColumn(
        ...
        item {
            ListItem(
                headlineContent = {
                    Text(text = if (artist.artist.bookmarkedAt != null) "Subscribed" else "Subscribe")
                },
                leadingContent = {
                    Icon(
                        painter = painterResource(if (artist.artist.bookmarkedAt != null) R.drawable.ic_favorite else R.drawable.ic_favorite_border),
                        contentDescription = null,
                    )
                },
